...
export const subAdminDashboard = async (data) => {
  try {
    const res = await axios.get(
      `${Config.base_url}Subadmindashboard/${data.userName}`
    );
    return res?.data;
  } catch (err) {
...
export const GetAllSubadminClient = async (data) => {
  ...
  try {
    const res = await axios.get(
      `${Config.base_url}SubadminClientdetails/${data.userName}`,
      {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
...
export const subadminGroups = async (data) => {
  ...
  try {
    const res = await axios.get(
      `${Config.base_url}SubAdminGrropselct/${data.subadmin}`,
      {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
