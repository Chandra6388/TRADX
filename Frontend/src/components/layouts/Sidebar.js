                            ...
                            {role === 'Admin' ? (
                                ...
                                (
                                    <>
                                        ...
                                        <li className={activeItem === '/superadmin/admin-activity' ? 'active' : ''} onClick={(e) => handleSidebarClick(e, '/superadmin/admin-activity')}>
                                            <Link to='/superadmin/admin-activity' className="iq-waves-effect">
                                                <i className="ri-home-fill" />
